...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_alarm-service-resources"></a> [alarm-service-resources](#module\_alarm-service-resources) | applike/alarm-service-resources/aws | 1.1.2 |
...
| <a name="input_propagate_tags"></a> [propagate\_tags](#input\_propagate\_tags) | Mode of propagating tags across services, task definitions and tasks. One of TASK\_DEFINITION or SERVICE. Set to NONE to prevent tags from being propagated. | `string` | `null` | no |
